...
foreach ( $users as $user ) {
    ...
    echo "
                <tr>
                  ...
                  <td>{$user['Password']}</td>
                  <td>{$isAdmin}</td>
                  <td><a href='edit.php?id={$user['ID']}' class='edit'>EDIT</button></td>
                  <td><a class='delete'>DELETE</button></td>
                </tr>";
}
?>
</tbody>
...
<h1>Added Tours: <?php echo count( $holidays_arr );
?></h1>
<div class = 'table-container'>
<table>
<thead class = 'fixed'>
...
<h1>Newsletter Subscribers: <?php echo count( $subscribed_users );
?></h1>
<div class = 'table-container'>
<table>
<thead class = 'fixed'>
...
<h1>Users Messages: <?php echo count( $contact_messages );
?></h1>
<div class = 'table-container'>
<table>
<thead class = 'fixed'>
